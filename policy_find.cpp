 ...
 */
template <typename T>
static optional_ns::optional<T> getProperty(const DbusPropertyMap& properties,
 ...
 */
static optional_ns::optional<std::string>
 ...
 * based on rules given by the IBM service team.
 *
 ...
 */
static auto getSearchModifier(const DbusPropertyMap& properties)
{
    std::string modifier;
